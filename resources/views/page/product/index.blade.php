...
<div class="col-12">
    <div class="border-left-Warning alert alert-danger" role="alert">
...
<div class="col-8">
    <div class="border-left-Warning alert alert-info" role="alert">
        {{ Session::get('message') }}
    </div>
</div>
@endif
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <a href="{{ route('product.create') }}" class="btn btn-orange btn-sm"
                                ...
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-orange"><i class="fa fa-search"></i>
                                        @lang('web.search')
                                    </button>
                                </div>
                            </div>
